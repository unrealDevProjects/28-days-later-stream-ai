...
def pil_to_frame(image: Image.Image) -> bytes:
    ...
    # Calidad 85 para buen balance entre calidad y rendimiento
    # Rango: 1-100, donde 85 es excelente calidad con buena compresión
    image.save(frame_data, format="JPEG", quality=85, optimize=False)
